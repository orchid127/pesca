...
function Navbar(props: NavbarProps) {
    return (
        <div className="pb-5">
            <div className="flex justify-end text-[2.25rem] font-kiwisoda p-[0.5rem] border border-[#F7C0DD] border-[2px] rounded-[10px] bg-gradient-to-b from-[#FCE8F3] via-[#F8C2DF] to-[#FCE8F3]">
